...
namespace BookResearcher
{
    class SignedRequestHelper
    {
         ...
         *  CA: ecs.amazonaws.ca
         */
        public SignedRequestHelper(AmazonSearch search)
        {
            endPoint = AmazonSearch.DESTINATION.ToLower();
            this.akid = search.AccessKeyId;
            this.secret = Encoding.UTF8.GetBytes(search.SecretKey);
        ...
        public string Sign(IDictionary<string, string> request)
        {
            ...
            sortedMap["AssociateTag"] = search.AssociateTag;
            sortedMap["Timestamp"] = this.GetTimestamp();
            sortedMap["ResponseGroup"] = search.ResponseGroup;
            sortedMap["SearchIndex"] = search.SearchIndex;
            sortedMap["Version"] = search.Year;
            sortedMap["Service"] = search.Service;
            sortedMap["Operation"] = search.Operation;
            sortedMap["IncludeReviewsSummary"] = search.IncludeReviewsSummary;
